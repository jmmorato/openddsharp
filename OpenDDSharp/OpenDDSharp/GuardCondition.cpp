...
System::Boolean OpenDDSharp::DDS::GuardCondition::GetTriggerValue() {
	return impl_entity->get_trigger_value();
}

OpenDDSharp::DDS::ReturnCode OpenDDSharp::DDS::GuardCondition::SetTriggerValue(System::Boolean value) {
	return (OpenDDSharp::DDS::ReturnCode)impl_entity->set_trigger_value(value);
}
