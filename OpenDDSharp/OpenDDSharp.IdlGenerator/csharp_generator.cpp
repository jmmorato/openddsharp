...
{		
	...
	be_global->impl_ << "\n"
					 ...
					 << "        #region Constants\n"
					 << "#if DEBUG\n"
					 << "        internal const string API_DLL_X86 = \"" << be_global->project_name() << "Wrapperd.x86.dll\";\n"
					 << "        internal const string API_DLL_X64 = \"" << be_global->project_name() << "Wrapperd.x64.dll\";\n"
				     << "#else\n"
					 << "        internal const string API_DLL_X86 = \"" << be_global->project_name() << "Wrapper.x86.dll\";\n"
					 << "        internal const string API_DLL_X64 = \"" << be_global->project_name() << "Wrapper.x64.dll\";\n"
					 << "#endif\n"
					 << "        #endregion\n\n"
					 << "        #region Fields" << "\n"
