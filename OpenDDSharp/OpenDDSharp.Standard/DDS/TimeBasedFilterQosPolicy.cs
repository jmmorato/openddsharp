...
namespace OpenDDSharp.DDS
{
    ...
    public sealed class TimeBasedFilterQosPolicy : IEquatable<TimeBasedFilterQosPolicy>
    {
        #region Properties
        /// <summary>
        /// Gets or sets the interval that defines a minimum delay between instance value changes; this permits the <see cref="DataReader" /> to throttle
        /// changes without affecting the state of the associated <see cref="DataWriter" />. By default, MinimumSeparation is zero, which indicates that no data is filtered.
        /// </summary>
    ...
    internal struct TimeBasedFilterQosPolicyWrapper
    {
        ...
        #region Operators
        /// <summary>
        /// Implicit conversion operator from <see cref="TimeBasedFilterQosPolicyWrapper" /> to <see cref="TimeBasedFilterQosPolicy" />.
        /// </summary>
        ...
        /// <summary>
        /// Implicit conversion operator from <see cref="TimeBasedFilterQosPolicy" /> to <see cref="TimeBasedFilterQosPolicyWrapper" />.
        /// </summary>
        /// <param name="value">The value to transform.</param>
