...
/// </summary>
public abstract class DataWriterListener : IDisposable
{
    #region Delegates
    ...
    {
        var entity = EntityManager.Instance.Find(writer);
    ...
    {
        UnsafeNativeMethods.DisposeDataWriterListener(_native);
...
internal static partial class UnsafeNativeMethods
{
#if NET7_0_OR_GREATER
    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "DataWriterListener_New")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial IntPtr NewDataWriterListener(
    ...
    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "DataWriterListener_Dispose")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial IntPtr DisposeDataWriterListener(IntPtr native);
#else
    [SuppressUnmanagedCodeSecurity]
    ...
    public static extern IntPtr DisposeDataWriterListener(IntPtr native);
#endif
}