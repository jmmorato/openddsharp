...
/// <summary>
/// This policy indicates the level of reliability requested by a <see cref="DataReader" /> or
/// offered by a <see cref="DataWriter" />.
/// </summary>
/// <remarks>
...
/// "offered kind &gt;= requested kind" evaluates to '<see langword="true" />'. For the purposes of this inequality,
/// the values of Reliability kind are considered ordered such that BestEffort &lt; Reliable.
/// </remarks>
...
internal struct ReliabilityQosPolicyWrapper
{
    ...
    #region Operators
    /// <summary>
    /// Implicit conversion operator from <see cref="ReliabilityQosPolicyWrapper" /> to
    /// <see cref="ReliabilityQosPolicy" />.
    /// </summary>
    ...
    /// <summary>
    /// Implicit conversion operator from <see cref="ReliabilityQosPolicy" /> to
    /// <see cref="ReliabilityQosPolicyWrapper" />.
    /// </summary>
    /// <param name="value">The value to transform.</param>
