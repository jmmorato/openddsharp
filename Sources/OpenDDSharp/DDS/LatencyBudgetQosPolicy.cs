...
internal struct LatencyBudgetQosPolicyWrapper
{
    ...
    #region Operators
    /// <summary>
    /// Implicit conversion operator from <see cref="LatencyBudgetQosPolicyWrapper" /> to
    /// <see cref="LatencyBudgetQosPolicy" />.
    /// </summary>
    ...
    /// <summary>
    /// Implicit conversion operator from <see cref="LatencyBudgetQosPolicy" /> to
    /// <see cref="LatencyBudgetQosPolicyWrapper" />.
    /// </summary>
    /// <param name="value">The value to transform.</param>
