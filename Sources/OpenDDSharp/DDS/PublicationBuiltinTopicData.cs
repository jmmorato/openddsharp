...
/// </summary>
/// <remarks>
/// The DCPSPublication topic communicates the existence of <see cref="DataWriter" />s by means of the
/// PublicationBuiltinTopicData datatype. Each PublicationBuiltinTopicData sample in a Domain represents a
/// <see cref="DataWriter" /> in that Domain: a new PublicationBuiltinTopicData instance is created when a
/// newly-added <see cref="DataWriter" /> is enabled, and it is disposed when that <see cref="DataWriter" /> is deleted.
/// An updated PublicationBuiltinTopicData sample is written each time the <see cref="DataWriter" />
/// (or the <see cref="Publisher" /> to which it belongs) modifies a QoS policy that applies to the entities
/// connected to it. Also will it be updated when the writer looses or regains its liveliness.
/// </remarks>
public struct PublicationBuiltinTopicData : IEquatable<PublicationBuiltinTopicData>
{
    ...
    /// <summary>
    /// Gets the global unique identifier of the <see cref="DomainParticipant" /> to which
    /// the <see cref="DataWriter" /> belongs.
    /// </summary>
    ...
    /// <summary>
    /// Gets the <see cref="PresentationQosPolicy" /> attached to the <see cref="Publisher" /> to which
    /// the <see cref="DataWriter" /> belongs.
    /// </summary>
    public PresentationQosPolicy Presentation { get; internal set; }

    /// <summary>
    /// Gets the <see cref="PartitionQosPolicy" /> attached to the <see cref="Publisher" /> to which
    /// the <see cref="DataWriter" /> belongs.
    /// </summary>
    public PartitionQosPolicy Partition { get; internal set; }

    /// <summary>
    /// Gets the <see cref="TopicDataQosPolicy" /> attached to the <see cref="Publisher" /> to which
    /// the <see cref="DataWriter" /> belongs.
    /// </summary>
    public TopicDataQosPolicy TopicData { get; internal set; }

    /// <summary>
    /// Gets the <see cref="GroupDataQosPolicy" /> attached to the <see cref="Publisher" /> to which
    /// the <see cref="DataWriter" /> belongs.
    /// </summary>
