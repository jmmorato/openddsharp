...
public sealed class ReaderDataLifecycleQosPolicy : IEquatable<ReaderDataLifecycleQosPolicy>
{
    ...
    /// regarding an instance once its InstanceState becomes NotAliveNoWriters. After this time elapses,
    /// the <see cref="DataReader" /> will purge all internal information regarding the instance,
    /// any un-taken samples will also be lost.
    /// </summary>
    ...
    /// an instance once its InstanceState becomes NotAliveDisposed. After this time elapses, the
    /// <see cref="DataReader" /> will purge all samples for the instance.
    /// </summary>
...
internal struct ReaderDataLifecycleQosPolicyWrapper
{
    ...
    #region Operators
    /// <summary>
    /// Implicit conversion operator from <see cref="ReaderDataLifecycleQosPolicyWrapper" /> to
    /// <see cref="ReaderDataLifecycleQosPolicy" />.
    /// </summary>
    ...
    /// <summary>
    /// Implicit conversion operator from <see cref="ReaderDataLifecycleQosPolicy" /> to
    /// <see cref="ReaderDataLifecycleQosPolicyWrapper" />.
    /// </summary>
    /// <param name="value">The value to transform.</param>
