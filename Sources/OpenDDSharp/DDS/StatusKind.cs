...
public readonly struct StatusKind : IEquatable<StatusKind>
{
    ...
    /// <summary>
    /// The deadline that the <see cref="DataWriter" /> has committed through its <see cref="DeadlineQosPolicy" />
    /// was not respected for a specific instance.
    /// </summary>
    public static readonly StatusKind OfferedDeadlineMissedStatus = 2U;

    /// <summary>
    /// The deadline that the <see cref="DataReader" /> was expecting through its <see cref="DeadlineQosPolicy" />
    /// was not respected for a specific instance.
    /// </summary>
    ...
    /// <summary>
    /// The liveliness that the <see cref="DataWriter" /> has committed to through its
    /// <see cref="LivelinessQosPolicy" /> was not respected,  thus <see cref="DataReader" /> entities will consider
    /// the <see cref="DataWriter" /> as no longer alive.
    /// </summary>
    public static readonly StatusKind LivelinessLostStatus = 2048U;

    /// <summary>
    /// The liveliness of one or more <see cref="DataWriter" /> that were writing instances read through the
    /// <see cref="DataReader" /> has changed. Some <see cref="DataWriter" /> have become alive or not alive.
    /// </summary>
    public static readonly StatusKind LivelinessChangedStatus = 4096U;

    /// <summary>
    /// The <see cref="DataWriter" /> has found <see cref="DataReader" /> that matches the <see cref="Topic" />
    /// and has compatible QoS.
    /// </summary>
    public static readonly StatusKind PublicationMatchedStatus = 8192U;

    /// <summary>
    /// The <see cref="DataReader" /> has found <see cref="DataWriter" /> that matches the <see cref="Topic" />
    /// and has compatible QoS.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new <see cref="StatusKind"/> from an <c>uint</c> value.
    /// </summary>
    ...
    /// <summary>
    /// Gets the <c>uint</c> value of the <see cref="StatusKind"/>.
    /// </summary>
    ...
    #region Operators
    /// <summary>
    /// Implicit conversion operator from <see cref="StatusKind" /> to <c>uint</c>.
    /// </summary>
    ...
    /// <summary>
    /// Implicit conversion operator from <c>uint</c> to <see cref="StatusKind" />.
    /// </summary>
    /// <param name="value">The value to transform.</param>
