...
internal struct DurabilityServiceQosPolicyWrapper
{
    ...
    #region Operators
    /// <summary>
    /// Implicit conversion operator from <see cref="DurabilityServiceQosPolicyWrapper" /> to
    /// <see cref="DurabilityServiceQosPolicy" />.
    /// </summary>
    ...
    /// <summary>
    /// Implicit conversion operator from <see cref="DurabilityServiceQosPolicy" /> to
    /// <see cref="DurabilityServiceQosPolicyWrapper" />.
    /// </summary>
    /// <param name="value">The value to transform.</param>
