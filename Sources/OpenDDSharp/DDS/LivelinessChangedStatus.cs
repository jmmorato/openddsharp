...
/// <summary>
/// The LivelinessChanged status indicates that there have been liveliness changes for one or more
/// <see cref="DataWriter">DataWriters</see> that are publishing instances for this <see cref="DataReader"/>.
/// </summary>
...
public struct LivelinessChangedStatus : IEquatable<LivelinessChangedStatus>
{
    ...
    #region Properties
    /// <summary>
    /// Gets the total number of <see cref="DataWriter">DataWriters</see> currently active on the topic this
    /// <see cref="DataReader"/> is reading.
    /// </summary>
    public int AliveCount => _aliveCount;

    /// <summary>
    /// Gets the total number of <see cref="DataWriter">DataWriters</see> writing to the <see cref="DataReader"/>'s
    /// topic that are no longer asserting their liveliness.
    /// </summary>
