...
/// <para>Each data sample written by the <see cref="DataWriter" /> has an associated 'expiration time' beyond which
/// the data should not be delivered to any application. Once the sample expires, the data will be removed from the
/// <see cref="DataReader" /> caches as well as from the transient and persistent information caches.</para>
/// </summary>
/// <remarks>
/// <para>
/// The value of this policy may be changed at any time. Changes to this policy affect only data written after
/// the change.
/// </para>
/// <para>
/// The 'expiration time' of each sample is computed by adding the duration specified by the Lifespan QoS to
/// the source timestamp.
/// </para>
/// <para>
/// This QoS relies on the sender and receiving applications having their clocks sufficiently synchronized.
/// If this is not the case and DDS can detect it, the <see cref="DataReader" /> is allowed to use the reception
/// timestamp instead of the source timestamp in its computation of the 'expiration time'.
/// </para>
/// </remarks>
