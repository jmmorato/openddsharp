...
/// </summary>
/// <remarks>
/// The DCPSSubscription topic communicates the existence of <see cref="DataReader" />s by means of the
/// SubscriptionBuiltinTopicData datatype. Each SubscriptionBuiltinTopicData sample in a Domain represents a datareader
/// in that Domain: a new SubscriptionBuiltinTopicData instance is created when a newly-added <see cref="DataReader" />
/// is enabled, and it is disposed when that <see cref="DataReader" /> is deleted. An updated
/// SubscriptionBuiltinTopicData sample is written each time the <see cref="DataReader" />
/// (or the <see cref="Subscriber" /> to which it belongs) modifies a QoS policy that applies to the
...
public struct SubscriptionBuiltinTopicData : IEquatable<SubscriptionBuiltinTopicData>
{
    ...
    /// <summary>
    /// Gets the global unique identifier of the <see cref="DomainParticipant" /> to
    /// which the <see cref="DataReader" /> belongs.
    /// </summary>
    ...
    /// <summary>
    /// Gets the <see cref="PresentationQosPolicy" /> attached to the <see cref="Subscriber" /> to which
    /// the <see cref="DataReader" /> belongs.
    /// </summary>
    public PresentationQosPolicy Presentation { get; internal set; }

    /// <summary>
    /// Gets the <see cref="PartitionQosPolicy" /> attached to the  <see cref="Subscriber" /> to which
    /// the <see cref="DataReader" /> belongs.
    /// </summary>
    public PartitionQosPolicy Partition { get; internal set; }

    /// <summary>
    /// Gets the <see cref="TopicDataQosPolicy" /> attached to the  <see cref="Subscriber" /> to which
    /// the <see cref="DataReader" /> belongs.
    /// </summary>
    public TopicDataQosPolicy TopicData { get; internal set; }

    /// <summary>
    /// Gets the <see cref="GroupDataQosPolicy" /> attached to the  <see cref="Subscriber" /> to which
    /// the <see cref="DataReader" /> belongs.
    /// </summary>
    ...
    /// <returns>
    /// <see langword="true" /> if the left object is equal to the right object;
    /// otherwise, <see langword="false" />.
    /// </returns>
