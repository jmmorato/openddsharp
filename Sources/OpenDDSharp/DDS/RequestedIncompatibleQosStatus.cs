...
/// <summary>
/// The RequestedIncompatibleQos status indicates that one or more QoS policy values that were requested were
/// incompatible with what was offered.
/// </summary>
public struct RequestedIncompatibleQosStatus : IEquatable<RequestedIncompatibleQosStatus>
{
    #region Fields
    ...
    /// <summary>
    /// Gets the sequence of values that indicates the total number of incompatibilities that have been detected
    /// for each QoS policy.
    /// </summary>
    ...
    #region Methods
    internal RequestedIncompatibleQosStatusWrapper ToNative()
    {
        ...
        return new RequestedIncompatibleQosStatusWrapper
        {
    ...
    internal void FromNative(RequestedIncompatibleQosStatusWrapper wrapper)
    {
    ...
    #region IEquatable<RequestedIncompatibleQosStatus> Members
    /// <summary>
    ...
    /// </returns>
    public bool Equals(RequestedIncompatibleQosStatus other)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals((RequestedIncompatibleQosStatus)obj);
    }
    ...
    /// </returns>
    public static bool operator ==(RequestedIncompatibleQosStatus left, RequestedIncompatibleQosStatus right)
    {
...
internal struct RequestedIncompatibleQosStatusWrapper
{
    #region Fields
