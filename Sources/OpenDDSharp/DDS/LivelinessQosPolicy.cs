...
/// <summary>
/// This policy controls the mechanism and parameters used by DDS to ensure that particular entities on the
...
/// <item>
/// <description>
/// The inequality "offered Kind &gt;= requested Kind" evaluates to 'true'. For the purposes of this inequality,
/// the values of Liveliness kind are considered ordered such that:
/// Automatic &lt; ManualByParticipant &lt; ManualByTopic.</description>
/// </item>
/// <item>
/// <description>The inequality "offered LeaseDuration &lt;= requested LeaseDuration" evaluates to 'true'.</description>
/// </item>
/// </list>
/// </remarks>
...
internal struct LivelinessQosPolicyWrapper
{
    ...
    #region Operators
    /// <summary>
    /// Implicit conversion operator from <see cref="LivelinessQosPolicyWrapper" /> to
    /// <see cref="LivelinessQosPolicy" />.
    /// </summary>
    ...
    /// <summary>
    /// Implicit conversion operator from <see cref="LivelinessQosPolicy" /> to
    /// <see cref="LivelinessQosPolicyWrapper" />.
    /// </summary>
    /// <param name="value">The value to transform.</param>
