...
public sealed class DomainParticipantFactory
{
    ...
    {
        var native = UnsafeNativeMethods.LookupParticipant(_native, domainId);
        ...
        var entity = EntityManager.Instance.Find(native);
        if (entity != null)
        {
...
internal static partial class UnsafeNativeMethods
{
    ...
    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "DomainParticipantFactory_DeleteParticipant")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial ReturnCode DeleteParticipant(IntPtr dpf, IntPtr dp);
    ...
    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "DomainParticipantFactory_LookupParticipant")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial IntPtr LookupParticipant(IntPtr pub, int domain);
#else
    [SuppressUnmanagedCodeSecurity]
    [DllImport(MarshalHelper.API_DLL, EntryPoint = "DomainParticipantFactory_CreateParticipant", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr CreateParticipant(IntPtr dpf, int domainId, [MarshalAs(UnmanagedType.Struct), In] DomainParticipantQosWrapper qos, IntPtr a_listener, uint mask);
