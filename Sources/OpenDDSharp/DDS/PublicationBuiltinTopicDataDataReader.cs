...
namespace OpenDDSharp.DDS
{
    ...
    public class PublicationBuiltinTopicDataDataReader : DataReader
    {
        ...
        /// <param name="maxSamples">The maximum allowed samples to be read.</param>
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode Take(List<PublicationBuiltinTopicData> receivedData,
            List<SampleInfo> receivedInfo,
            int maxSamples)
        {
            return Take(receivedData,
        ...
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode ReadInstance(List<PublicationBuiltinTopicData> receivedData, List<SampleInfo> receivedInfo, InstanceHandle handle)
        {
        ...
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode ReadInstance(List<PublicationBuiltinTopicData> receivedData,
            List<SampleInfo> receivedInfo,
        ...
        /// <param name="handle">The provided <see cref="InstanceHandle"/> that indicates the instance to be read.</param>
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode TakeInstance(List<PublicationBuiltinTopicData> receivedData, List<SampleInfo> receivedInfo, InstanceHandle handle)
        {
        ...
        /// <param name="maxSamples">The maximum retrieved samples allowed per call.</param>
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode TakeInstance(List<PublicationBuiltinTopicData> receivedData,
            List<SampleInfo> receivedInfo,
            InstanceHandle handle,
            int maxSamples)
        {
        ...
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode ReadNextInstance(List<PublicationBuiltinTopicData> receivedData,
            List<SampleInfo> receivedInfo,
        ...
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode TakeNextInstance(List<PublicationBuiltinTopicData> receivedData, List<SampleInfo> receivedInfo, InstanceHandle previousHandle)
        {
        ...
        /// <param name="maxSamples">The maximum retrieved samples allowed per call.</param>
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode TakeNextInstance(List<PublicationBuiltinTopicData> receivedData,
            List<SampleInfo> receivedInfo,
            InstanceHandle previousHandle,
            int maxSamples)
        {
        ...
        private static class UnsafeNativeMethods
        {
            ...
            public static extern int ReadNextSample(IntPtr dr, [MarshalAs(UnmanagedType.Struct), In, Out] ref PublicationBuiltinTopicDataWrapper data, [In, Out] ref SampleInfoWrapper sampleInfo);
            ...
            public static extern int TakeNextSample(IntPtr dr, [MarshalAs(UnmanagedType.Struct), In, Out] ref PublicationBuiltinTopicDataWrapper data, [In, Out] ref SampleInfoWrapper sampleInfo);
            ...
            public static extern int LookupInstance(IntPtr dr, PublicationBuiltinTopicDataWrapper instance);
            ...
            public static extern int GetKeyValue(IntPtr dr, [MarshalAs(UnmanagedType.Struct), In, Out] ref PublicationBuiltinTopicDataWrapper data, int handle);
        }
        #endregion
    }
}
