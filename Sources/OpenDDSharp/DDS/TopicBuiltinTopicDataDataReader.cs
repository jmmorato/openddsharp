...
namespace OpenDDSharp.DDS
{
    ...
    public class TopicBuiltinTopicDataDataReader : DataReader
    {
        ...
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode ReadInstance(List<TopicBuiltinTopicData> receivedData, List<SampleInfo> receivedInfo, InstanceHandle handle)
        {
        ...
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode ReadInstance(List<TopicBuiltinTopicData> receivedData,
            List<SampleInfo> receivedInfo,
        ...
        /// <param name="handle">The provided <see cref="InstanceHandle"/> that indicates the instance to be read.</param>
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode TakeInstance(List<TopicBuiltinTopicData> receivedData, List<SampleInfo> receivedInfo, InstanceHandle handle)
        {
        ...
        /// <param name="maxSamples">The maximum retrieved samples allowed per call.</param>
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode TakeInstance(List<TopicBuiltinTopicData> receivedData,
            List<SampleInfo> receivedInfo,
            InstanceHandle handle,
            int maxSamples)
        {
        ...
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode ReadNextInstance(List<TopicBuiltinTopicData> receivedData,
            List<SampleInfo> receivedInfo,
        ...
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode TakeNextInstance(List<TopicBuiltinTopicData> receivedData, List<SampleInfo> receivedInfo, InstanceHandle previousHandle)
        {
        ...
        /// <param name="maxSamples">The maximum retrieved samples allowed per call.</param>
        /// <returns>The <see cref="ReturnCode" /> that indicates the operation result.</returns>
        public ReturnCode TakeNextInstance(List<TopicBuiltinTopicData> receivedData,
            List<SampleInfo> receivedInfo,
            InstanceHandle previousHandle,
            int maxSamples)
        {
        ...
        private static class UnsafeNativeMethods
        {
            ...
            public static extern int ReadNextSample(IntPtr dr, [MarshalAs(UnmanagedType.Struct), In, Out] ref TopicBuiltinTopicDataWrapper data, [In, Out] ref SampleInfoWrapper sampleInfo);
            ...
            public static extern int TakeNextSample(IntPtr dr, [MarshalAs(UnmanagedType.Struct), In, Out] ref TopicBuiltinTopicDataWrapper data, [In, Out] ref SampleInfoWrapper sampleInfo);
            ...
            public static extern int LookupInstance(IntPtr dr, TopicBuiltinTopicDataWrapper instance);
            ...
            public static extern int GetKeyValue(IntPtr dr, [MarshalAs(UnmanagedType.Struct), In, Out] ref TopicBuiltinTopicDataWrapper data, int handle);
        }
        #endregion
    }
}
