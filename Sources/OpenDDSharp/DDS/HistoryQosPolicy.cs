...
/// <summary>
/// This policy controls the behavior of DDS when the value of an instance changes before it is finally communicated
/// to some of its existing <see cref="DataReader" /> entities.
/// </summary>
/// <remarks>
/// <para>This policy defaults to a <see cref="HistoryQosPolicyKind.KeepLastHistoryQos"/> with a
/// <see cref="HistoryQosPolicy.Depth"/> of one.</para>
/// <para>The setting of <see cref="HistoryQosPolicy.Depth"/> must be consistent with the
/// <see cref="ResourceLimitsQosPolicy.MaxSamplesPerInstance"/> .
