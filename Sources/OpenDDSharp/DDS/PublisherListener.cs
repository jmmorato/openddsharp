...
/// <summary>
/// Abstract class that can be implemented by an application-provided class and then registered with the
/// <see cref="Publisher" /> such that the application can be notified of relevant status changes.
/// </summary>
public abstract class PublisherListener : IDisposable
{
    ...
    /// <para>The <see cref="StatusKind.OfferedIncompatibleQosStatus" /> indicates that an offered QoS was
    /// incompatible with the requested QoS of a <see cref="DataReader" />.</para>
    /// </summary>
    /// <param name="writer">The <see cref="DataWriter" /> that triggered the event.</param>
    ...
    /// <para>The <see cref="StatusKind.LivelinessLostStatus" /> indicates that the liveliness that the
    /// <see cref="DataWriter" /> committed through its Liveliness QoS has not been respected.
    /// This means that any connected <see cref="DataReader" />s will consider this <see cref="DataWriter" /> no
    /// longer active.</para>
    /// </summary>
    /// <param name="writer">The <see cref="DataWriter" /> that triggered the event.</param>
    ...
    /// <para>The <see cref="StatusKind.PublicationMatchedStatus" /> indicates that the liveliness that the
    /// <see cref="DataWriter" /> committed through its Liveliness QoS has not been respected. This means that any
    /// connected <see cref="DataReader" />s will consider this <see cref="DataWriter" /> no longer active.</para>
    /// </summary>
    /// <param name="writer">The <see cref="DataWriter" /> that triggered the event.</param>
...
internal static partial class UnsafeNativeMethods
{
#if NET7_0_OR_GREATER
    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "PublisherListener_New")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial IntPtr NewPublisherListener(
    ...
    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "PublisherListener_Dispose")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial IntPtr DisposePublisherListener(IntPtr native);
#else
    [SuppressUnmanagedCodeSecurity]
    [DllImport(MarshalHelper.API_DLL, EntryPoint = "PublisherListener_New", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr NewPublisherListener(
        IntPtr onOfferedDeadlineMissed,
        IntPtr onOfferedIncompatibleQos,
        IntPtr onLivelinessLost,
        IntPtr onPublicationMatched);
