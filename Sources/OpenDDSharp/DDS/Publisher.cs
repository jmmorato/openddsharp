...
/// <remarks>
/// <para>
/// The Publisher acts on the behalf of one or several <see cref="DataWriter" /> objects that belong to it.
/// When it is informed of a change to the data associated with one of its <see cref="DataWriter" /> objects,
/// it decides when it is appropriate to actually send the data-update message. In making this decision, it considers
/// any extra information that goes with the data (timestamp, writer, etc.) as well as the QoS of the Publisher and
/// the <see cref="DataWriter" />.
/// </para>
/// <para>
/// All operations except for the operations SetQos, GetQos, SetListener, GetListener, Enable, GetStatusCondition,
/// CreateDataWriter, and DeleteDataWriter return the value <see cref="ReturnCode.NotEnabled" /> if the Publisher
...
public class Publisher : Entity
{
    ...
    /// <remarks>
    /// <para>
    /// The created <see cref="DataWriter" /> will be attached and belongs to the <see cref="Publisher" />
    /// that is its factory.
    /// </para>
    /// <para>
    /// The <see cref="Topic" /> passed to this operation must have been created from the same
    /// <see cref="DomainParticipant" /> that was used to create this <see cref="Publisher" />.
    /// If the <see cref="Topic" /> was created from a different <see cref="DomainParticipant" />,
    /// the operation will fail and return a <see langword="null"/> result.
    /// </para>
    /// </remarks>
    ...
    /// that is its factory.
    /// </para>
    /// <para>The <see cref="Topic" /> passed to this operation must have been created from the same
    /// <see cref="DomainParticipant" /> that was used to create this <see cref="Publisher" />.
    /// If the <see cref="Topic" /> was created from a different <see cref="DomainParticipant" />,
    /// the operation will fail and return a <see langword="null"/> result.
    /// </para>
    ...
    /// <summary>
    /// Creates a new <see cref="DataWriter" /> with the desired QoS policies and attaches to it the specified
    /// <see cref="DataWriterListener" />. The specified <see cref="DataWriterListener" /> will be attached with the
    ...
    {
        ReturnCode ret = UnsafeNativeMethods.PublisherDeleteContainedEntities(_native);
        if (ret == ReturnCode.Ok)
        {
    ...
    public ReturnCode SetListener(PublisherListener listener, StatusMask mask)
    {
        ...
        return UnsafeNativeMethods.PublisherSetListener(_native, ptr, mask);
    }
    ...
    {
        return UnsafeNativeMethods.PublisherWaitForAcknowledgments(_native, maxWait);
    }
    ...
    {
        return UnsafeNativeMethods.PublisherNativeNarrowBase(ptr);
    }
    ...
    {
        IntPtr ptrParticipant = UnsafeNativeMethods.PublisherGetParticipant(_native);
...
internal static partial class UnsafeNativeMethods
{
#if NET7_0_OR_GREATER
    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "Publisher_NarrowBase")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial IntPtr PublisherNativeNarrowBase(IntPtr ptr);
    ...
    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "Publisher_DeleteDataWriter")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial ReturnCode DeleteDataWriter(IntPtr pub, IntPtr dataWriter);

    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "Publisher_SetListener")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial ReturnCode PublisherSetListener(IntPtr pub, IntPtr listener, uint mask);

    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "Publisher_GetParticipant")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial IntPtr PublisherGetParticipant(IntPtr pub);

    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "Publisher_LookupDataWriter", StringMarshalling = StringMarshalling.Utf8)]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial IntPtr LookupDataWriter(IntPtr pub, string topicName);

    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "Publisher_DeleteContainedEntities")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial ReturnCode PublisherDeleteContainedEntities(IntPtr pub);

    [SuppressUnmanagedCodeSecurity]
    [DllImport(MarshalHelper.API_DLL, EntryPoint = "Publisher_WaitForAcknowledgments", CallingConvention = CallingConvention.Cdecl)]
    public static extern ReturnCode PublisherWaitForAcknowledgments(IntPtr pub, Duration maxWait);

    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "Publisher_SuspendPublications")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial ReturnCode SuspendPublications(IntPtr pub);

    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "Publisher_ResumePublications")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial ReturnCode ResumePublications(IntPtr pub);

    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "Publisher_BeginCoherentChanges")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial ReturnCode BeginCoherentChanges(IntPtr pub);

    [SuppressUnmanagedCodeSecurity]
    [LibraryImport(MarshalHelper.API_DLL, EntryPoint = "Publisher_EndCoherentChanges")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial ReturnCode EndCoherentChanges(IntPtr pub);
#else
    [SuppressUnmanagedCodeSecurity]
    [DllImport(MarshalHelper.API_DLL, EntryPoint = "Publisher_NarrowBase", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr PublisherNativeNarrowBase(IntPtr ptr);
    ...
    public static extern ReturnCode PublisherSetListener(IntPtr pub, IntPtr listener, uint mask);

    [SuppressUnmanagedCodeSecurity]
    [DllImport(MarshalHelper.API_DLL, EntryPoint = "Publisher_GetParticipant", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr PublisherGetParticipant(IntPtr pub);
    ...
    public static extern ReturnCode PublisherDeleteContainedEntities(IntPtr pub);
