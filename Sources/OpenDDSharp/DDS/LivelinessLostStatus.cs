...
/// <summary>
/// The LivelinessLost status indicates that the liveliness that the data writer committed through its
/// Liveliness QoS has not been respected. This means that any connected data readers will consider this
/// <see cref="DataWriter" /> no longer active.
/// </summary>
[StructLayout(LayoutKind.Sequential)]
public struct LivelinessLostStatus : IEquatable<LivelinessLostStatus>
{
    #region Fields
    ...
    #region IEquatable<LivelinessLostStatus> Members
    /// <summary>
    ...
    /// </returns>
    public bool Equals(LivelinessLostStatus other)
    {
    ...
    {
        return (obj is LivelinessLostStatus other) && Equals(other);
    }
    ...
    /// </returns>
    public static bool operator ==(LivelinessLostStatus left, LivelinessLostStatus right)
    {
