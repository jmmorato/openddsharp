...
namespace OpenDDSharp {
	namespace DDS {
		...
		/// <summary>
		/// This policy controls whether DDS allows multiple <see cref="OpenDDSharp::DDS::DataWriter" /> objects to update the same instance (identified by Topic + key) of a data-object.
		/// </summary>
