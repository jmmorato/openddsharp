...
bool cwrapper_generator::gen_enum(AST_Enum *node, UTL_ScopedName *name, const std::vector<AST_EnumVal *> &contents,
                                  const char *repoid) {
  return true;
}
...
bool
cwrapper_generator::gen_struct(AST_Structure *structure, UTL_ScopedName *name, const std::vector<AST_Field *> &fields,
...
bool
cwrapper_generator::gen_union(AST_Union *, UTL_ScopedName *name, const std::vector<AST_UnionBranch *> &, AST_Type *,
                              const char *) {
