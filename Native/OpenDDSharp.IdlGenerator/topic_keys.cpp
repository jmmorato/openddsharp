...
TopicKeys::Iterator::Iterator()
    : parent_(0), pos_(0), child_(0), current_value_(0), root_(0), root_type_(InvalidType), level_(0),
      recursive_(false), element_count_(0), implied_keys_(false) {
}

TopicKeys::Iterator::Iterator(TopicKeys &parent)
    : parent_(0), pos_(0), child_(0), current_value_(0), level_(0), recursive_(parent.recursive()), element_count_(0),
      implied_keys_(false) {
  root_ = parent.root();
...
TopicKeys::Iterator::Iterator(AST_Type *root, Iterator *parent)
    : parent_(parent), pos_(0), child_(0), current_value_(0), level_(parent->level() + 1),
      recursive_(parent->recursive_), element_count_(0), implied_keys_(false) {
...
TopicKeys::Iterator::Iterator(const Iterator &other)
    : pos_(0), child_(0), current_value_(0), root_(0), root_type_(InvalidType), level_(0), recursive_(false),
      element_count_(0), implied_keys_(false) {
  *this = other;
}
