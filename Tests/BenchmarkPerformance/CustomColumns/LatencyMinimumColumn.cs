...
internal class LatencyMinimumColumn : IColumn
{
    public static readonly string OutputFolder = Path.Combine(Path.GetTempPath(), nameof(LatencyMinimumColumn));

    /// <inheritdoc/>
    public string Id => nameof(LatencyMinimumColumn);

    /// <inheritdoc/>
    public string ColumnName => "Latency Minimum";
    ...
    /// <inheritdoc/>
    public string Legend => "Sample latency minimum in milliseconds";
    ...
    public string GetValue(Summary summary, BenchmarkCase benchmarkCase)
    {
        ...
        var filename = Path.Combine(OutputFolder, $"{name}-latency-minimum.{numInstances}.{numSamples}.{payloadSize}.txt");
